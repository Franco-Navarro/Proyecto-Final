<?php
    ...
    if(isset($_POST["suscripcion-gratis"])){
        if($nivel == 'gratuito'){
            $mensaje = 'Usted ya tiene una cuenta gratuita.';
        }else{
    ...
    <main class="main" id="main">        
        <section class="seccion-perfil" id="seccion-perfil">
            <div class="tipo-suscripcion-gratuita">
                ...
                <div>
                    <form id="form-registro" action="gratis.php" class="registro-izq-form" method="POST">
                        <div class="tipo-suscripcion-button">
                            <input type="submit" value="Registro gratuito" name="suscripcion-gratis" id="suscripcion-gratis"></button>
                        </div>
                    </form>
                </div> 
